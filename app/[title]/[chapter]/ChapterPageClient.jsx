  ...
  const renderPara = (para, i) => {
    ...
    return (
      <p
        ...
        style={{ color: 'var(--theme-text)', fontFamily: activeTheme.typography?.body === 'mono' ? 'var(--font-mono)' : 'inherit' }}
        ...
        <article className="max-w-2xl md:max-w-3xl mx-auto pt-10">
          <header className="text-center mb-10 border-b pb-8" style={{ borderColor: 'var(--theme-border)' }}>
            ...
            <h1
              ...
              style={{ color: 'var(--theme-primary)', fontFamily: activeTheme.typography?.heading === 'sans' ? 'var(--font-sans)' : 'inherit' }}
            >
              Chapter {chapter.chapterNumber}
            </h1>
            {chapter.title && (
              <p className="text-xl md:text-2xl italic opacity-85 mb-4" style={{ color: 'var(--theme-text-secondary)' }}>
                {chapter.title}
              </p>
            )}
